...
[camunda-archetype-ejb-war-7.22.0](https://docs.camunda.org/manual/latest/user-guide/process-applications/maven-archetypes/).
...
Built and tested against Camunda Platform version 7.22.0 on WildFly 27+ Application Server.
